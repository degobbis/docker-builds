...
.PHONY: build-minica build-all-httpd build-apache24 build-all-php build-php73 build-php74 build-php80 build-php81 build-all-php-eol build-php56 build-all-db build-mariadb104 build-mariadb105 build-mariadb106
...
build-all-db: build-mariadb106 build-mariadb105 build-mariadb104 ## Build all latest db images and tag as :latest
...
build-mariadb106: ## Build latest MariaDB 10.5 image and tag as :latest
